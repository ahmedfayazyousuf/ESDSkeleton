...
const BookRoom= () => {
    ...
    function carClick(e){
        ...
        if(e === 'One'){
            ...
            document.getElementById('Ten').style.background = "transparent";
            document.getElementById('Eleven').style.background = "transparent";
            document.getElementById('Twelve').style.background = "transparent";
        }
    ...
    return(
        ...
        <div>
            ...
            <div style={{display: 'flex', flexDirection: 'column', textAlign: 'center', margin: '0', padding: '0'}} >
                <p style={{fontSize: '15px', marginBottom: '0', marginTop: '10px', color: 'white'}} >Choose a Room</p>
            </div>  
